...
type ProtoSystemStateId = "permission-denied" | "not-found" | "session-expired" | "recoverable-error" | "critical-error";
...
function protoSystemStateId(): ProtoSystemStateId {
  ...
  const validos: ProtoSystemStateId[] = ["permission-denied", "not-found", "session-expired", "recoverable-error", "critical-error"];
